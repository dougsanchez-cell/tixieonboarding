  ...
  },
  {
    ...
    content: (
      <ul className="space-y-2 text-sm" style={{ color: "#9898B0" }}>
        ...
        <li>📄 For visual examples of seat maps and section layouts, see the <a href="https://opyxdjxlkobucilpyqgi.supabase.co/storage/v1/object/public/Docs/Tixie%20Tester%20Guideline%20-%20Updated%204_15_2026.pdf" target="_blank" rel="noopener noreferrer" className="text-[#8B50CC] underline hover:text-[#a76de8]">Tixie Tester Guideline</a></li>
      </ul>
    ),
  },
  {
  ...
  },
  {
    ...
    content: (
      <div className="space-y-3 text-sm" style={{ color: "#9898B0" }}>
        ...
        <p>📄 For the complete guide with visual examples, see the <a href="https://opyxdjxlkobucilpyqgi.supabase.co/storage/v1/object/public/Docs/Tixie%20Tester%20Guideline%20-%20Updated%204_15_2026.pdf" target="_blank" rel="noopener noreferrer" className="text-[#8B50CC] underline hover:text-[#a76de8]">Tixie Tester Guideline</a></p>
      </div>
    ),
  },
];
