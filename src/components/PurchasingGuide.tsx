...
const GUIDE_SECTIONS = [
  ...
  },
  {
    ...
    body: `Think about it from a fan's perspective — within your assigned section, pick the seats you'd want if you were going to the show. Closer to the stage is <strong>ALWAYS better</strong>. On the seat map, blue seats are available and grey seats are unavailable — only select from the blue seats. NEVER purchase seats labeled <strong>LV</strong> (Limited View), <strong>OV</strong> (Obstructed View), <strong>SS</strong> (Side Stage), <strong>WC</strong> (Wheelchair), or <strong>ADA</strong> — unless the Request explicitly states they are acceptable. When in doubt, use the Select Option dropdown and move to the next request. For visual examples of seat maps and section layouts, see the <a href="https://opyxdjxlkobucilpyqgi.supabase.co/storage/v1/object/public/Docs/Tixie%20Tester%20Guideline%20-%20Updated%204_14_2026.pdf" target="_blank" rel="noopener noreferrer">Tixie Tester Guideline</a>. For guidance on interpreting section names like Floor, GA, ranges, and Pit, see the <a href="https://opyxdjxlkobucilpyqgi.supabase.co/storage/v1/object/public/Docs/Tixie%20Purchasing%20Sections%20Playbook.pdf" target="_blank">Purchasing Sections Playbook</a>.`,
  },
  {
