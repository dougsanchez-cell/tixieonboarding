      ...
      >
        <div className="w-full max-w-md">
          ...
          <div className="mb-6 px-4 py-3 rounded-xl text-sm flex items-start gap-3"
            ...
            <span>Complete this orientation to get cleared for live purchasing. Questions? Email <a href="mailto:gigsupport@jomero.co" className="underline text-[#8B50CC]">gigsupport@jomero.co</a></span>
          </div>
